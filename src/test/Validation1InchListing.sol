...
contract Validation1InchListing is Test {
    ...
    address public constant ONEINCH_WHALE = 0x2f3Fa8b85fbD0e29BD0b4E68032F61421782BDF0;
    ...
    function _testProposal(address payload) internal {
        ...
        AaveV2Helpers._validateCountOfListings(1, allConfigsBefore, allConfigsAfter);
        ...
        AaveV2Helpers._noReservesConfigsChangesApartNewListings(allConfigsBefore, allConfigsAfter);
        ...
        AaveV2Helpers._validateReserveTokensImpls(
            ...
            ReserveTokens({
                ...
                variableDebtToken: OneInchListingPayload(payload).VARIABLE_DEBT_IMPL()
            }),
            MARKET_NAME
        );
    ...
    function _validatePoolActionsPostListing(ReserveConfig[] memory allReservesConfigs) internal {
        AaveV2Helpers._deposit(
            ...
            666 ether,
            true,
            AaveV2Helpers._findReserveConfig(allReservesConfigs, "1INCH", false).aToken,
            MARKET_NAME
        );
        AaveV2Helpers._deposit(
            vm,
            ...
            666 ether,
            true,
            AaveV2Helpers._findReserveConfig(allReservesConfigs, "AAVE", false).aToken,
            MARKET_NAME
        );
        ...
        AaveV2Helpers._borrow(
            ...
            10 ether,
            2,
            AaveV2Helpers._findReserveConfig(allReservesConfigs, "DAI", false).variableDebtToken,
            MARKET_NAME
        );
        ...
        AaveV2Helpers._borrow(
            ...
            10 ether,
            2,
            AaveV2Helpers._findReserveConfig(allReservesConfigs, "1INCH", false).variableDebtToken,
            MARKET_NAME
        );
        ...
        try
            AaveV2Helpers._borrow(
                ...
                10 ether,
                1,
                AaveV2Helpers._findReserveConfig(allReservesConfigs, "1INCH", false).stableDebtToken,
                MARKET_NAME
            )
        {
